...
static msg_t message[] = {
	...
	{RC_E_STACK_OVERFLOW,         "Error (0x14): Call stack exceeded maximum capacity"},
	{RC_E_STACK_UNDERFLOW,        "Error (0x15): Unmatched OP_RET executed with an empty call stack"},
	{RC_E_STRING_OVERFLOW,        "Error (0x16): String Length exceeds limits"},
	...
	{RC_E_INVALID_SEEK,           "Error (0x25): Invalid Seek - Unrecognized seek origin or offset occurred."},
	{RC_E_TOO_MANY_OPEN_FILES,    "Error (0x26): Exceeded total limit of open files"},
	{RC_E_NO_SPACE_LEFT,          "Error (0x27): Storage media or virtual disk partition is full"},
	{RC_E_FILE_EXISTS,            "Error (0x28): Attempt to recreate an already existing file"},
