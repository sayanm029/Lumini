...
* **modern syntax & features**
    ...
    * **Platform Independence:** Utilize LuminiVM for seamless cross-platform execution.
    * **Blazing-Fast Production:** Employs the Lumini Compiler to generate optimized, platform-specific machine code.
    * **AOT Compilation Backend:** Use libgccjit for high-performance Ahead-Of-Time code generation & C compatibility.
...
* [ ] Lumini VM
	...
	* [x] Bug fix .. 1
	* [ ] Tests
	* [ ] Bug fix .. 2  (if appeared in testing phase)
	* [ ] Documentation
	* [ ] workflow
